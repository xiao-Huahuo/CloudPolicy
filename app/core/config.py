...
class GlobalConfig:
    ...
    AUTH_CAPTCHA_EXPIRE_SECONDS = int(os.getenv("AUTH_CAPTCHA_EXPIRE_SECONDS", "300"))
    AUTH_CODE_EXPIRE_MINUTES = int(os.getenv("AUTH_CODE_EXPIRE_MINUTES", "10"))
    AUTH_SEND_COOLDOWN_SECONDS = int(os.getenv("AUTH_SEND_COOLDOWN_SECONDS", "60"))
    AUTH_MAX_VERIFY_ATTEMPTS = int(os.getenv("AUTH_MAX_VERIFY_ATTEMPTS", "5"))
    AUTH_SANDBOX_SMS = _to_bool(os.getenv("AUTH_SANDBOX_SMS", "1"))
